...
<div class="max-w-4xl mx-auto space-y-6">
    <div class="bg-white rounded-2xl p-6 shadow-lg border border-gray-100">
        <div class="flex items-center mb-4">
            ...
            <div>
                ...
                <p class="text-gray-600">Masukkan informasi lengkap anggota gereja baru</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100">
        <div class="p-6">
            ...
            <form action="{{ route('jemaat.store') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" id="nik" name="nik" value="{{ old('nik') }}" required
                            ...
                            placeholder="Masukkan 10 digit NIK">
                    </div>
                    ...
                    <div>
                        ...
                        <select id="cabang" name="cabang" required
                            ...
                            @foreach ($cabangs as $cabangItem)
                                <option value="{{ $cabangItem->name }}" {{ old('cabang') == $cabangItem->name ? 'selected' : '' }}>{{ $cabangItem->name }}</option>
                            @endforeach
                        </select>
                        @if ($cabangs->isEmpty())
                ...
                <div class="flex flex-col sm:flex-row gap-4 pt-6 border-t border-gray-100">
                    ...
                    <button type="submit"
                        ...
                        <i class="fas fa-save mr-2"></i>Simpan Data Jemaat
                    </button>
                </div>
            </form>
        </div>
